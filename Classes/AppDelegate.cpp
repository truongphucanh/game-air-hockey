...
static cocos2d::Size mediumResolutionSize = cocos2d::Size(786, 1024);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("air-hockey", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
...
void AppDelegate::setSearchPaths()
{
    ...
    searchPaths.emplace_back("sounds");
